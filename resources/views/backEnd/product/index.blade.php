...
@section('content')
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <a href="{{ route('products.create') }}" class="btn btn-danger rounded-pill"><i class="fe-shopping-cart"></i> Add
            Product</a>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <ul class="action2-btn">
                                    ...
                                    <li><a href="{{ route('products.update_deals', ['status' => 0]) }}"
                                            class="btn  rounded-pill btn-danger hotdeal_update"><i
                                                class="fe-thumbs-down"></i> Flash Sale</a></li>
                        ...
                        <th style="width:8%">Flash Sale</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list custom-btn-list">
                                            ...
                                            @if ($value->order_by == 1)
                                                <a href="{{ route('productbulkquantity.index',$value->id) }}" title="Edit" class="btn btn-sm bg-success p-1 text-white">Bulk Quantity</a>
                                            @endif
                                    ...
                                    <!-- <td>{{ $value->stock }}</td> -->
                                    {{-- <td>
                                        <p class="m-0">Flash Sales : {{ $value->topsale == 1 ? 'Yes' : 'No' }}</p>
