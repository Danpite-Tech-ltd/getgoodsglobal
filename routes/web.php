...
Route::get('/datafeed.csv', [FrontendController::class, 'datafeed'])->name('datafeed');
...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::post('get/quantity/cart', [FrontendController::class, 'quantity_cart']);
    ...
    // Route::post('/campaign/order', [FrontendController::class, 'campaign_order'])->name('campaign.order');
...
Route::group(['prefix' => 'customer', 'namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::post('/landingpage/order-save', [CustomerController::class, 'landingpageorder_save'])->name('landingpage.ordersave');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    // desposit expense date filtering
    Route::get('deposit-expense/filtering', [DashboardController::class, 'dashboard'])->name('deposit.filtering');
    Route::get('orders-dashboard/filtering', [DashboardController::class, 'dashboard'])->name('orders-dashboard.filtering');
    ...
    // bankroute
    Route::get('bank/manage', [BankController::class, 'index'])->name('bank.index');
    ...
    Route::post('bank/inactive', [BankController::class, 'inactive'])->name('bank.inactive');
    Route::post('bank/active', [BankController::class, 'active'])->name('bank.active');
    Route::post('bank/destroy', [BankController::class, 'destroy'])->name('bank.destroy');
    ...
    Route::get('feature/banner/edit/{id}', [BannerController::class, 'edit_feature'])->name('featurebanner.edit');
    Route::post('feature/banner/update/{id}', [BannerController::class, 'update_feature'])->name('featurebanner.update');
    ...
    Route::get('slip-print', [OrderController::class, 'slip_print'])->name('admin.order.slip_print');
    ...
    // map list
    Route::get('/map/list', [OrderController::class, 'maplist'])->name('maplist');
    ...
    Route::post('review/{id}/update', [ReviewController::class, 'update'])->name('reviews.update');
    Route::post('review/destroy', [ReviewController::class, 'destroy'])->name('reviews.destroy');

    // district  route
    Route::get('district/manage', [ShippingChargeController::class, 'district'])->name('district.index');
    Route::get('district/create', [ShippingChargeController::class, 'district_create'])->name('district.create');
    Route::post('district/store', [ShippingChargeController::class, 'district_store'])->name('district.store');
    Route::get('district/edit/{id}', [ShippingChargeController::class, 'district_edit'])->name('district.edit');
    Route::post('district/update/{id}', [ShippingChargeController::class, 'district_update'])->name('district.update');
    Route::get('district/destroy/{id}', [ShippingChargeController::class, 'district_destroy'])->name('district.destroy');
    // thana  route
    Route::get('thana/manage', [ShippingChargeController::class, 'thana'])->name('thana.index');
    Route::get('thana/create', [ShippingChargeController::class, 'thana_create'])->name('thana.create');
    Route::post('thana/store', [ShippingChargeController::class, 'thana_store'])->name('thana.store');
