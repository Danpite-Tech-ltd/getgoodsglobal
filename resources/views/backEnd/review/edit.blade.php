    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('reviews.update',$edit_data->id) }}" method="POST" class=row data-parsley-validate=""
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="feedback" rows="6" class="summernote form-control @error('feedback') is-invalid @enderror">{{ $edit_data->feedback }}</textarea>
                                    @error('feedback')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 mb-3 d-none">
                                <div class="form-group">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($edit_data->image) }}" alt="" width="50">
                                    </div>
                                </div>
                            </div>
                            <!-- col end -->
