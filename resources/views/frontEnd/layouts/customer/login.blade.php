            ...
            <div class="col-sm-5">
                <div class="form-content">
                    ...
                    <form action="{{route('customer.signin')}}" method="POST"  data-parsley-validate="">
                        ...
                        <!-- col-end -->
                        <a href="{{route('customer.forgot.password')}}" class="forget-link"><i class="fa-solid fa-unlock"></i> Forgotten Password?</a>
                        <div class="form-group mb-3">
                     ...
                     <div class="register-now no-account">
                        ...
                        <a href="{{route('customer.register')}}"><i data-feather="edit-3"></i>Register Here?</a>
                    </div>
                </div>
            </div>
        </div>
