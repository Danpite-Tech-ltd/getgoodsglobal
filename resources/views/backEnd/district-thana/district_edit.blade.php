...
<div class="container-fluid">
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="{{route('district.update',$district->id)}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="districtName" class="form-label">District Name *</label>
                            <input type="districtName" class="form-control @error('districtName') is-invalid @enderror" name="districtName" value="{{ $district->districtName }}" id="districtName" required="">
                            @error('districtName')
