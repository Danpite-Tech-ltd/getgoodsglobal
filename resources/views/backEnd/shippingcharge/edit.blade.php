                ...
                <div class="card-body">
                    <form action="{{route('shippingcharges.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6 d-none">
                            <div class="form-group mb-3">
                                <label for="to_amount" class="form-label">To Amount (per kg)</label>
                                <input type="text" class="form-control @error('to_amount') is-invalid @enderror" name="to_amount" value="{{ $edit_data->to_amount }}" id="to_amount" />
                                @error('to_amount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
